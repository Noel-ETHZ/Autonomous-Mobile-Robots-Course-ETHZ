...
def calculateDescriptorDistances(des1, des2):
    # TODO: Compute L2 distance squared using matrix multiplication
    raise NotImplementedError

def getMutualMatchingMask(dist, best_index):
    # TODO: Find mask to filter all non-mutual maches
    raise NotImplementedError

def getRatioMask(dist, sorted_indices, threshold=0.7):
...
ratio_mask = getRatioMask(dist, sorted_indices)
